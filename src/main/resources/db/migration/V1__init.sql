...
CREATE TABLE passenger (
                           passengerId BIGINT GENERATED BY DEFAULT AS IDENTITY PRIMARY KEY,
                           name VARCHAR(255),
...
CREATE TABLE ticket (
                        ...
                        CONSTRAINT FK_ticket_client FOREIGN KEY (client_id) REFERENCES passenger(passengerId) ON DELETE CASCADE,
